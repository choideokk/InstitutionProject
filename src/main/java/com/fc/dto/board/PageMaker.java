...
public class PageMaker {
	...
	private Criterai cri;
	
	//화면에 보여지는 페이지블럭의 수
	private int displayPageNum = 10;

	public PageMaker() {}
	public PageMaker(int totalCount, int startPage, int endPage, boolean prev, boolean next, Criterai cri,
			int displayPageNum) {
		super();
	...
	public Criterai getCri() {
		return cri;
	}

	public void setCri(Criterai cri) { //변경
		this.cri = cri;
	}
