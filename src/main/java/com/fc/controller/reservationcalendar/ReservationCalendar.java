...
public class ReservationCalendar {
	...
	public String clearMyReservation(@RequestBody ReservationCalendarDto reservationCalendarDto, HttpSession session,
			Model model) {
	...
	public String reservationCalendar(@RequestParam("rsvfNm") String rsvfNm, @RequestParam("category") String category,
			@RequestParam("date") Date date, HttpSession session, Model model) {
	...
	/***
	 * 
	 * @param reservationCalendarDto
	 * @param model
	 * @param session
	 * @return
	 */
	@RequestMapping("/Calendar3")
	public String calendar3(ReservationCalendarDto reservationCalendarDto, Model model, HttpSession session) {
		...
		String phoneNumber = member.getPhoneNum(); // Assumed that the MemberDto has a method getPhoneNumber() to get
													// the phone number
	...
	public String calendar4(ReservationCalendarDto reservationCalendarDto, Model model, HttpSession session) {
