			...
			<table class="table" id="article-table">
				...
				<tbody>
					...
					<fmt:formatDate pattern="yyyy/MM/dd"
						...
						<td><c:out value="${comment.report}" />1</td>		
					</tr>			
				</c:forEach>	
                                    ...
                                    <p>
                                        <div class="form-group">
                                            <input type="text" id="commentParentName" name="commentParentName" class="form-control col-lg-2" data-rule-required="true" placeholder="작성자 : " maxlength="10" value="아이디 : ${sessionScope.loginId} 님" readonly>                                          
                                        </div>      
                                    </p>
  					 <form method="POST" action="${path}/reply?postno=${viewPage.postno}">
                                        <textarea id="replytext" name="replytext" class="form-control col-lg-12" style="width:100%" rows="4"></textarea>
                        ...
                        <thead>
                            <tr>
                                <td>
        							...
        							<button type="button" id="chochun"  class="btn btn-default">댓글 추천 </button>
										<button type="button" id="singo"  class="btn btn-default">댓글 신고</button>
                                      </form>                           
                                   </span>
                                </td>
                            </tr>
